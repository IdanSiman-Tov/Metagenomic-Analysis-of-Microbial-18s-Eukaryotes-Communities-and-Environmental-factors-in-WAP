...
```{r}
 ...
 Group_3<- do.call("cbind", list(data_for_pca, Rhizaria.Cercozoa, Stramenopiles.Dictyochophyceae.Dictyochales.and.Florenciellales.and.otherDictyochophyceae, Stramenopiles.MAST_2.and.MAST_3, Stramenopiles.Ochrophyta.other))
...
plot(NMDS_Group_1_fit, cex =1.5, main = title(main = "Medium Consolidatoin Group 1 NMDS"))



plot(NMDS_Group_2, "sites")
NMDS_Group_2_fit <- envfit(NMDS_Group_2, Group_2, permu=999)
plot(NMDS_Group_2_fit, cex =1.5, main = title(main = "Medium Consolidatoin Group 2 NMDS"))


plot(NMDS_Group_3, "sites")
NMDS_Group_3_fit <- envfit(NMDS_Group_3, Group_3, permu=999)
plot(NMDS_Group_3_fit, cex =1.5, main = title(main = "Medium Consolidatoin Group 3 NMDS"))


plot(NMDS_Group_4, "sites")
NMDS_Group_4_fit <- envfit(NMDS_Group_4, Group_4, permu=999)
plot(NMDS_Group_4_fit, cex =1.5, main = title(main = "Medium Consolidatoin Group 4 NMDS"))
