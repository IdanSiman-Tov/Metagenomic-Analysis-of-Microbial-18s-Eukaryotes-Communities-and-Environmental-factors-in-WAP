...
metagenome_taxa_removed <- function(){
  ...
  Metagenome <- read.xlsx("..//..//18s_Metagnome//18s_andMetagenome_taxaCounts_updatedSept2022_no_percentage.xlsx", sheetIndex=2, header= FALSE)
  ...
  Metagenome_Taxa_counts<- Metagenome[5:26,5:20]
