...
data_for_pca <-function(){
  ...
  # Note that I replaced all \\ file paths with // so that mac could work. if my pc version breaks i recommend checking this first
  ...
  sample_dates <- c("2012-11-27", "2013-02-08", "2013-12-27", "2014-01-23", "2014-02-03", "2014-02-10", "2014-02-28", "2014-03-04", "2014-12-01", "2014-12-11", "2015-01-12", "2015-01-19", "2015-02-09", "2015-02-23", "2015-03-09")
